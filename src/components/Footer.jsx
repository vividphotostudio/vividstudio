...
const Footer = () => {
  return (
    <>
      <footer id="footer" className="modern">
        <div className="container" style={{width: '1400px'}}>
          <div className="widg clearfix">
            <div id="wiso_copyright_widget-2" className="sidebar-item col-xs-12 col-sm-6 col-md-4 CopyrightWidget">
            ...
            <div id="text-3" className="sidebar-item col-xs-12 col-sm-6 col-md-4 widget_text">
              <div className="item-wrap">
                <h5>Information</h5>
            ...
            <div id="wiso_subscribe_widget-2" className="sidebar-item col-xs-12 col-sm-6 col-md-4 SubscribeWidget">
              <div className="item-wrap">
                <div className="wiso-widget-subscribe">
                  <h3 className="wiso-widget-subscribe">Subscribe</h3>
                  <div role="form" className="wpcf7" id="wpcf7-f3211-o1" lang="en" dir="ltr">
                    <div className="screen-reader-response"></div>
                    <form className="wpcf7-form" noValidate="novalidate">
                      <p><span className="wpcf7-form-control-wrap email"><input type="email" name="email" value="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Enter your-email" /></span></p>
      ...
      <a href="https://api.whatsapp.com/send?phone=9150056656&text=" className="float" target="_blank" rel="noopener noreferrer">
